...
import mockupDesktop from "../../assets/images/main.svg";
import mockupMobile from "../../assets/images/main.svg";
    ...
    >
      ...
      <div className="my-[0.4375rem] flex flex-1 flex-col justify-center gap-[3.0625rem] text-center text-normal md:my-[1.5625rem] md:mx-[2.1875rem] md:text-left lg:my-[6.4375rem]">
        ...
        <p className="max-w-[43ch] leading-[1.6] tracking-[0.01em] text-medium-gray transition duration-300 ease-in-out dark:text-almost-white md:text-normal max-md:mx-auto">
         Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, delectus? Aliquid necessitatibus nihil, eaque minima est quod quibusdam, reiciendis omnis asperiores minus odio expedita vero voluptates dignissimos id. Fugiat, quasi?
        </p>
        <a
          href="#"
